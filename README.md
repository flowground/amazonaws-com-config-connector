# ![LOGO](logo.png) AWS Config MSP Connector

## Description

A generated MSP connector for the AWS Config API (version 2014-11-12).
...
flowground :- Telekom iPaaS / amazonaws-com-config-connector<br/>
